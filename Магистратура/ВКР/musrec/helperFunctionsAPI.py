...
keep = ['id', 'acousticness', 'danceability', 'energy', 'instrumentalness', 'liveness', 'loudness', 'speechiness', 'valence', 'tempo']
...
def getRecommendations(featureVector, way, K, trackId):
    ...
    recommendations = knn.getKNN(item_profile[keep], way, K, trackId, featureVector)
    response = {}
