			...
			<div class="container">
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="featured-artist-content">
                        ...
                        <div class="section-heading white text-left mb-30">
	                        <span id="artist_name">Артист: <f:out value="${fetchedData[3] }"></f:out></span><br> 
	                        <span id="album_name">Альбом: <f:out value="${fetchedData[5] }"></f:out></span><br>
	                        <span id="release_date">Дата: <f:out value="${fetchedData[2] }"></f:out></span><br> 
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading style-2">
                        <p>Вам также могут понравиться эти песни</p>
                        <h2>Потому что вы интересовались <f:out value="${fetchedData[1] }"></f:out></h2>
                    </div>
                </div>
            </div>
