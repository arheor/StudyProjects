  ...
  <script type="text/javascript">
  	function fetchDataPy(){
		...
		if(song_name=='' && artist_name=='' && album_name==''){
	        ...
	        {
			  console.error("Ошибка подключения к: ", SERVER_URL);
	        };
    ...
    <title>Сервис рекомендации музыки</title>
    <meta charset="utf-8">
  ...
  <body>
	...
	<div class="main-section">
		...
		<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
			<div class="container">
					<a class="navbar-brand" href="/">Добро пожаловать, <f:out value="${userinfo.fname}"></f:out>.</a>
					<div class="col-sm-12 col-sm-offset-5">
						<button type="button" class="btn btn-outline-light" onclick="location.href='questionset.htm'">Рекомендовать музыку</button>
					</div>
			</div>
		</nav>
		...
		<section class="ftco-section" id="inputs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="heading-section mb-4">Поиск</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="form-group has-default">
							<input type="text" class="form-control" placeholder="Название трека" name="song_name" id="song_name">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group has-default">
							<input type="text" class="form-control" placeholder="Название исполнителя" name="artist_name" id="artist_name">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group has-default">
							<input type="text" class="form-control" placeholder="Название альбома" name="album_name" id="album_name">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12 col-sm-offset-5 text-center">
						<button type="button" class="btn btn-outline-light find-button" onclick="fetchDataPy()">Поиск</button>
					</div>
				</div>
			</div>
		</section>
