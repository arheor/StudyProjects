						...
						<form class="form-login" method="post" action="savedata.htm" onsubmit="return validateInfo()">
							<div class="card-body pb-4 pt-2">
								<div class="input-group mb-3">
										...
										<input type="text" id="fn" name="fn" class="form-control" placeholder="Имя">
								</div>
								<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text">
										...
										<input type="text" id="ln" name="ln" class="form-control" placeholder="Фамилия">
								</div>
								<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text">
								...
								<div class="input-group mb-3">
										...
										<input type="text" id="cnt" name="cnt" class="form-control" placeholder="Страна">
								</div>
								<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text">
