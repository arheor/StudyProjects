...
public class MainController {
	...
	@RequestMapping(value="/validat.htm", method=RequestMethod.POST)
	public ModelAndView search(HttpServletRequest request, HttpServletResponse response){
		HttpSession session = request.getSession();
		User user = (User) session.getAttribute("sessionUser");
		return new ModelAndView("landingPage.jsp","userinfo",user);
	}
	...
	public ModelAndView renderQuestionPage(HttpServletRequest request, HttpServletResponse response){
		HttpSession session = request.getSession();
		User user = (User) session.getAttribute("sessionUser");
		return new ModelAndView("questionForm.jsp","userinfo",user);
	}
