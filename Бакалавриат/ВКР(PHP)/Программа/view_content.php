...
<ul class="block-add-cart">
<a id="style-price" >'.group_numerals($row1["price"]).' руб</a>
...
<a style="display:none;" class="image-modal" id="image'.$row["id"].'" ><img  src="./uploads_images/'.$row["image"].'" /></a>
';
}
