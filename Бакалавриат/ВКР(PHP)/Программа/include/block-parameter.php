<?php
	defined('e-shop') or die('Доступ запрещен');
?>
...
trackbar.getObject('one').init(
{
        ...
        if((int)$_GET["start_price"] >= 1000 AND (int)$_GET["start_price"] <= 150000)
        {
...
?>,
        ...
        if((int)$_GET["end_price"] >= 1000 AND (int)$_GET["end_price"] <= 150000)
        {
